...
--
-- Host: localhost    Database: relacionamentos
-- ------------------------------------------------------
...
INSERT INTO `departamento` VALUES (1,'Vendas'),(2,'TI');
...
CREATE TABLE `gerente` (
  ...
  CONSTRAINT `gerente_ibfk_1` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gerente` VALUES (1,'Ana Silva',1),(2,'Carlos Santos',2);
...
INSERT INTO `matricula` VALUES (1,1,4),(1,2,4),(2,1,4),(3,3,4);
...
CREATE TABLE `postagem` (
  ...
  CONSTRAINT `postagem_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`)
...
INSERT INTO `postagem` VALUES (1,'Primeira Postagem',1),(2,'Segunda Postagem',2),(3,'Terceira Postagem',3),(4,'Quarta Postagem',1),(5,'Quinta Postagem',2),(6,'Sexta Postagem',3);
...
INSERT INTO `usuario` VALUES (1,'João Silva'),(2,'Maria Oliveira'),(3,'Carlos Santos');
...
-- Dump completed on 2025-05-21 21:27:15
